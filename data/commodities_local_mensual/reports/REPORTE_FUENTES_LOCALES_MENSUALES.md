...
|---|---|---|---|---|---|---|---|---|---|
| Precios internos de principales granos — Secretaría de Agricultura / Mercados Agropecuarios | Oficial/institucional, sujeto a validar la serie y versión concreta | Mercado interno argentino | Mensual | ARS/TN si la publicación lo explicita | Trigo, maíz, sorgo, soja, girasol, cebada forrajera | A relevar producto por producto; no asumir que todos comienzan en el mismo año | Media: preferir descarga estructurada; mantener fallback manual | Puede cambiar el archivo, la definición del precio o la cobertura; requiere confirmar condiciones comerciales | **Primera opción** para histórico local mensual |
...
1. Investigar primero la serie mensual de precios internos de la Secretaría y confirmar nombre exacto, fecha, unidad, moneda, cobertura y condiciones de uso.
...
El pipeline local mensual queda preparado, sin descargar datos por defecto. La fuente local aparece como opción independiente en el módulo Commodities, pero permanece vacía hasta contar con un archivo en `raw/` que haya sido revisado. SIO continúa consumiendo sus propios CSV dashboard-ready y World Bank no se carga en esta etapa.
