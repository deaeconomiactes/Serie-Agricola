...
|---|---|---|---|---|---|---|---|---|---|
| BCR / Cámara Arbitral | Local institucional / referencia de mercado; precio de pizarra | Soja, maíz, trigo, girasol, sorgo, cebada y otros según cobertura | Potencialmente diaria | Según publicación; validar $/Tn y ARS/USD | Consulta y descarga manual; API/GIX a confirmar | API puede requerir credenciales | Mayor cercanía con mercado físico argentino y referencia de pizarra | Sin credenciales actuales; condiciones de uso y estructura deben confirmarse | Mantener como fuente preferida; usar manual hasta contar con acceso estable |
| SIO Granos | Local institucional; operaciones y precios de referencia | Granos y oleaginosas según operación/cobertura | Operativa/diaria, validar | La publicación puede unificar condiciones; validar unidad y moneda | Plataforma y documentación de API pública | Evaluar según recurso | Primera alternativa local automatizable a explorar y potencialmente analítica | Todavía no se validó una respuesta real; deben confirmarse endpoints, cobertura, permisos, condición y definición de precio | Investigar primero |
...
Las fuentes alternativas sólo están documentadas para comparación. SIO Granos cuenta únicamente con un explorador técnico separado y no productivo. No se crean todavía descargadores específicos para World Bank, BCRA, FAO o granos.ar. El pipeline BCR existente se mantiene como prueba controlada separada y no se realizan llamadas automáticas desde este comparativo.
